...
class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    @objc func loginCodex(_: Any?) {
        CodexQuotaService.shared.login()
    }
    ...
    func createMenu() {
        ...
        menu.addItem(withTitle: "刷新 Codex 额度", action: #selector(refreshCodexQuota(_:)), keyEquivalent: "R")
        menu.addItem(withTitle: "登录 Codex…", action: #selector(loginCodex(_:)), keyEquivalent: "")
